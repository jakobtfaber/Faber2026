...
candidate co-detection sample and describe the data products from each
telescope. We then detail the association test, the dispersion-measure budget
model, the foreground census used to identify potential intervening screens,
the two-band scattering model, the scintillation analysis, and the band-limited
energy calculation. The association tests, the foreground census, and the
dispersion-measure budget are reported in full; the scattering, scintillation,
turbulence, and energetics results are presented in their respective sections.
