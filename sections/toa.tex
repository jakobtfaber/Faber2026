...
scattering bias, as described next. Promotion of that correction is fail-closed:
the fit must pass the numerical quality gate and its diagnostic figure must be
...
for multi-component bursts; if the model gate is cleared, those terms are folded
...
peak offset and the V6 timing budget---the combined shared-DM referral error,
intrinsic pulse width, and inter-site clock term---rather than the unvalidated
model extension.
