...
chance-maximizing windows below, the eight DM-constrained pairs have
...
Evaluated with the conservative windows above, the eight DM-constrained bursts
have $P_{\rm cc}<10^{-8}$ individually, while each of the four pairs without a
constraining CHIME DM has the deliberately less selective position-and-time-only
...
and, where available, DM agreement provide independent checks. All twelve pass
the positional-coincidence check. The eight bursts with constrained CHIME-side DMs
