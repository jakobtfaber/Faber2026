...
artifact of the prior. The final per-sightline $\tau$/$\alpha$ adjudication under
this uniform re-fit is still being locked; until it is, the predicted intervening
contribution along every sightline---the quantity we can compute without a
measurement---is presented in Section~\ref{sec:budget} and
Figure~\ref{fig:budget}, and we treat completing the direct
measured-versus-predicted comparison as the principal remaining step for the
sample.
