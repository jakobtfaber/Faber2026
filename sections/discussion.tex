...
% TODO(disc-johndoeii / FRB 20230814B): Interpret after revalidation. If the
% galaxy-interior classification survives, explain the cap/extrapolation choice
% and whether the host-redshift limitation changes the conclusion.
...
% TODO(disc-energies): Fill after Section~\ref{sec:burst-energies} is restored.
% Explain what the band-restricted energies do and do not mean. Separate
% calibration, spectral-shape, host-redshift, and selection-rule limitations.
% Avoid using an energy row to support a population statement unless the
