...
FRB~20220506D, but the corresponding scattering fit has not yet cleared its
independent validation ladder. We therefore report the bandwidth without
turning it into an event-level screen attribution. The two-screen machinery of
Appendix~\ref{app:twoscreen} remains the formal framework for that later step.
