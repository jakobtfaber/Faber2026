...
confirm nor exclude scintillation at CHIME frequencies. The DSA-band products
and scattering fits have not yet cleared their current validation gates, so no
event-level screen attribution is made in this version of the manuscript. The
