...
This section is intentionally held as an interpretation scaffold until the
Results section is repopulated from re-validated analyses. Once those results
are trusted, the discussion should interpret them sightline by sightline before
returning to the population-level claims.

\subsection{Physical interpretation after re-validation}
