...
confirm nor exclude scintillation at CHIME frequencies. Screen attribution
therefore rests on the DSA-band scintillation products, the scattering fits,
and the foreground census alone, and the two-screen machinery of
Appendix~\ref{app:twoscreen} is applied within the DSA band.
