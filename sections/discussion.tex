...
instrumental and data-quality driven, not sky statements: they neither
confirm nor exclude scintillation at CHIME frequencies. The DSA-band ACF
products now clear their independent measurement gates, but event-level screen
attribution additionally requires an accepted DM-locked pulse-broadening fit;
we therefore do not infer a screen for any sightline whose joint fit fails or
remains only diagnostic. The
two-screen machinery of Appendix~\ref{app:twoscreen} is retained as the formal
framework for the revalidated analysis.
