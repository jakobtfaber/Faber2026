...
For each sightline that ultimately has a spectroscopic host redshift and a
trusted per-band amplitude fit, the energy calculation will estimate the
...
Energy rows are withheld in this circulation draft until the spectral
amplitudes, calibration path, host-redshift provenance, and inclusion rule pass
the V3 re-validation checks.
