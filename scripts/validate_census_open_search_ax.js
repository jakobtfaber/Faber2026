...
async function main() {
  ...
  const burstsCsvPath = path.join(__dirname, '../analysis/campaigns/foregrounds/data/frozen_census/bursts.csv');
  const registryCsvPath = path.join(__dirname, '../analysis/campaigns/foregrounds/data/intervening_census_registry.csv');
