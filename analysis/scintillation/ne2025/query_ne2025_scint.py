...
def _tau_sbw_1ghz(gl, gb, model):
    ...
    model in {'ne2001','ymw16'} reuses foregrounds.propagation.sightline_budget.galactic_dm_tau
    ...
    from foregrounds.propagation.sightline_budget import galactic_dm_tau
