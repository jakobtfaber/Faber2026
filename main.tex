...
with per-band multiplicity, the well-constrained sightlines yield predominantly
sub-Kolmogorov indices stable to $\le0.1$ under the PBF choice. Fixed-s²
component adjudication is complete for the four Tier-B sightlines; population-level
$\alpha$ statistics and the measured-versus-predicted budget overlay remain
qualitative pending FINAL figure regeneration in the \texttt{dsa110-FLITS} pipeline.
\end{abstract}
