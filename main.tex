...
temporal sub-components bias the single-component scattering index, motivating a
multi-component joint fit; a systematic re-measurement of the sample's scattering
indices is underway.
\end{abstract}
